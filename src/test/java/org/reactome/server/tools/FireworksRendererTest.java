...
public class FireworksRendererTest {
    private static final String TOKEN_OVER_1 = "MjAyNTAyMjExNDE4MjBfNA%253D%253D"; // uniprot (GBM Uniprot)
    private static final String TOKEN_EXPRESSION_1 = "MjAyNTAyMjExNzA2MDJfNg%253D%253D";  // microarray (probeset)
    private static final String TOKEN_EXPRESSION_2 = "MjAyNTAzMTMxNDQ2NDhfMTk%253D";  // HPA (GeneName)
    private static final String TOKEN_SPECIES = "MjAyNTAzMTMxNDQ3MTRfMjA%253D"; // canis

    private static final String TOKEN_TISSUE = "MjAyNTAzMTMxNDQ3MzdfMjE%253D"; // tissue with 35 columns
    private static final String TOKEN_COSMIC = "MjAyNTAzMTMxNDQ4MDhfMjI%253D"; // COSMIC
    private static final String TOKEN_GSA = "MjAyNTAzMTMxNDUyNDRfMjY%3D";
    private static final String TOKEN_GSVA = "MjAyNTAzMTMxNDUxNDJfMjU%3D";
